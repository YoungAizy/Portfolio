    ...
    return(
        ...
        <div className={styles.container}>
          ...
          <div>
            ...
            <div className={styles.buttons}>
              <button><a href="https://github.com/YoungAizy/PERN-Stack-App"  target="_blank"
        rel="noopener noreferrer"><GoMarkGithub/> Code</a></button>
              <button><a href="https://feed-reviewer.netlify.app/"  target="_blank"
        ...
        <div className={styles.container}>
          ...
          <div>
            ...
            <div className={styles.buttons}>
              <button><a href="https://github.com/YoungAizy/movie-mania-web"  target="_blank"
        rel="noopener noreferrer"><GoMarkGithub/> Code</a></button>
              <button><a href="https://movie-mania-e9031.web.app/"  target="_blank"
        rel="noopener noreferrer"><GoLinkExternal/> Live</a></button>
            </div>
          </div>
        </div>
